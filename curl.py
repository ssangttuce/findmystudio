...
headers = {
    ...
    # 'cookie': 'NNB=3AJGDW7D4MOGM; page_uid=i3UkBdqo1awsslVyhcCssssssSC-101215; landHomeFlashUseYn=Y; ba.uuid=0; NDV_SHARE=SEqwKe5IlPymiuRJ69ZA4KGub3Ao1ejNzIcMODTWFTxL5YwP6MEeJR9U6JZZ4460vs9aBoYOL8MAJjH2llNaSc7Nmv/DTLaYP6l+mQwZiucK; nid_inf=85052801; NID_JKL=VPNNXxpLtIKcebM07xPaQJHtYzdx4mayO74CiANKWOw=; BUC=CL9GbSx5fk1DrWTIyyIYi1CX3YFtplnOgnliSWNNPwA=; nhn.realestate.article.rlet_type_cd=Z03; nhn.realestate.article.trade_type_cd=B2; REALESTATE=Tue%20Jan%2021%202025%2014%3A30%3A35%20GMT%2B0900%20(Korean%20Standard%20Time)',
    'dnt': '1',
    'priority': 'u=1, i',
